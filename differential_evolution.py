...
def differential_evolution(bounds, args=(), strategy='best1bin',
    ...
    # cleared up.
    with DifferentialEvolutionSolver(bounds, args=args,
                                     strategy=strategy,
                                     maxiter=maxiter,
...
class DifferentialEvolutionSolver(object):
    ...
    def _calculate_population_energies(self, population):
        ...
        try:
            value = input("Please enter the list of cost value for {}, in the format 1,2,3,...\n".format(parameters_pop[0:nfevs]))
            calc_energies = list(value.split(','))
            calc_energies = list(map(float,calc_energies))
            ...
            for candidate in range(self.num_population_members):
                ...
                if self._wrapped_constraints:
                    ...
                    if not np.sum(cv) > 0:
                        ...
                        feasible = True
                        energy = input("Please enter function value for {}\n".format(parameters))
                        energy = float(energy)
    ...
    def _mutate(self, candidate):
        ...
        r0, r1 = samples[:2]
        #print('factor:{}, vectors {},{},{}'.format(self.scale,self.population[0],self.population[r0],self.population[r1]))
